...
def extract_features(img_file):
    ...
    rhog_features = get_hog_features(img[:,:,0], 9, 8, 2)
#    ghog_features = get_hog_features(img[:,:,1], 9, 8, 2)
#    bhog_features = get_hog_features(img[:,:,2], 9, 8, 2)
    color_bin_features = bin_spatial(img, 'HSV')
    return np.concatenate((color_bin_features, rhog_features))
...
#    print(data_look(car_image_files, non_car_image_files))
...
#    print('For labels:')
#    print(y_test[0:100])
#    print(len(np.intersect1d(pred, y_test[100])))
